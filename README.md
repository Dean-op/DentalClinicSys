...
- 患者端：个人中心、模拟充值、男女头像区分、公告浏览、医生查询、医生排班查看、药品购买、在线预约、预约管理、订单管理、病例查看、留言管理、医生评分、AI 牙医、用药提醒
- 医生端：公告查看、药品查看、男女头像区分、挂号费维护、排班维护、预约审核、待接诊、接诊与病例维护、电子药单、病例管理、留言回复、个人统计
...
- 预约挂号和药品购买都会优先从患者余额扣减；药品退款审批通过后、符合条件的挂号退款会退回余额
